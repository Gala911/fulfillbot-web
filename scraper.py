...
KEYWORDS = {
    "receiving_place": ["приёмк", "приемк", "разгрузк", "короб", "паллет"],
    "receiving_unit": ["приёмк", "приемк", "пересчёт", "пересчет", "поштучн"],
    "marking": ["маркировк", "стикер", "честны", "штрихкод", "этикетк"],
    "packing": ["упаковк", "сборк", "комплектаци"],
    "storage": ["хранени"],
    "shipment_prep": ["оформлени поставк", "создание поставк"],
